@extends('layouts.app')
@section('title', $service->name . ' - Spesialis Kaca Film')
...
<div class="bg-white border-b border-gray-100 relative z-10 -mt-8 mx-4 md:mx-auto md:max-w-6xl rounded-xl shadow-xl p-6 md:p-8">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center divide-x divide-gray-100">
        <div class="flex flex-col items-center gap-2">
            ...
            <div>
                <span class="block text-xs text-gray-400 uppercase tracking-widest">Produk</span>
                <span class="font-bold text-slate-800">100% Original</span>
            </div>
        </div>
        <div class="flex flex-col items-center gap-2">
            <div class="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-brand-primary">
            ...
            <div>
                <span class="block text-xs text-gray-400 uppercase tracking-widest">Pengerjaan</span>
                <span class="font-bold text-slate-800">2-4 Jam</span>
            </div>
        </div>
        <div class="flex flex-col items-center gap-2">
            <div class="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-brand-primary">
            ...
            <div>
                <span class="block text-xs text-gray-400 uppercase tracking-widest">Layanan</span>
        ...
        <div class="flex flex-col items-center gap-2">
            ...
            <div>
                <span class="block text-xs text-gray-400 uppercase tracking-widest">Garansi</span>
                <span class="font-bold text-slate-800">Resmi 5 Thn</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="w-full lg:w-2/3">
            ...
            <section class="mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-primary/30 transition-colors">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-brand-primary text-white flex items-center justify-center font-bold">1</span>
                        <div>
                            <h4 class="font-bold text-slate-800">Pembersihan Kaca</h4>
                            <p class="text-sm text-slate-500 mt-1">Sterilisasi kaca dari jamur dan debu mikroskopis.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-primary/30 transition-colors">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-brand-primary text-white flex items-center justify-center font-bold">2</span>
                        <div>
                            <h4 class="font-bold text-slate-800">Pola Presisi</h4>
                            <p class="text-sm text-slate-500 mt-1">Pemotongan kaca film menggunakan teknik heat shrinking.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-primary/30 transition-colors">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-brand-primary text-white flex items-center justify-center font-bold">3</span>
                        <div>
                            <h4 class="font-bold text-slate-800">Pemasangan</h4>
                            <p class="text-sm text-slate-500 mt-1">Instalasi di ruang tertutup untuk meminimalisir debu.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-brand-primary/30 transition-colors">
                        <span class="flex-shrink-0 w-8 h-8 rounded-full bg-brand-primary text-white flex items-center justify-center font-bold">4</span>
                        <div>
                            <h4 class="font-bold text-slate-800">Quality Control</h4>
                            <p class="text-sm text-slate-500 mt-1">Pengecekan akhir sebelum serah terima unit.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="portfolio-section" class="mb-12">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <a href="{{ route('portfolio.index') }}" class="text-sm text-brand-primary font-bold hover:underline">Lihat Semua &rarr;</a>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 bg-white border border-gray-100">
                        ...
                        <div class="p-4 relative">
                            ...
                            <p class="text-xs text-slate-400 mt-1">{{ $portfolio->car_model ?? 'Mobil Customer' }}</p>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <section>
                <h2 class="text-2xl font-bold text-slate-900 mb-6">Pertanyaan Umum</h2>
                <div class="space-y-4">
                    <details class="group bg-white rounded-xl shadow-sm border border-gray-100 p-4 [&_summary::-webkit-details-marker]:hidden">
                        <summary class="flex items-center justify-between cursor-pointer">
                            <h3 class="font-semibold text-slate-700">Apakah pemasangan bisa dilakukan di rumah?</h3>
                        ...
                        <p class="mt-4 leading-relaxed text-slate-500 text-sm">
                            Ya, kami menyediakan layanan Home Service untuk wilayah Jabodetabek. Pastikan Anda memiliki area tertutup (seperti garasi) dan akses listrik.
                        </p>
                    </details>
        ...
        <aside class="w-full lg:w-1/3">
            <div id="booking-card" class="sticky top-28 space-y-8">
                ...
                <div class="bg-white rounded-3xl shadow-2xl shadow-blue-900/10 overflow-hidden border border-slate-100 relative">
                    ...
                    <div class="p-8">
                        <p class="text-slate-500 font-medium text-sm mb-1 uppercase tracking-wider">Start From</p>
                        ...
                        <p class="text-center text-xs text-slate-400">Respon cepat dalam 5 menit</p>
                    </div>
                </div>
                ...
                <div class="bg-slate-900 rounded-2xl p-6 text-center text-white relative overflow-hidden group cursor-pointer">
                    ...
                    <div class="relative z-10">
                        <h4 class="font-bold text-xl mb-2">Diskon Spesial?</h4>
                        <p class="text-slate-300 text-sm mb-4">Dapatkan potongan harga untuk pemasangan Full Body.</p>
                        <a href="{{ route('whatsapp.redirect') }}" class="inline-block text-xs font-bold border border-white/30 px-4 py-2 rounded-full hover:bg-white hover:text-slate-900 transition-all">Tanya Promo</a>
                    </div>
                </div>
